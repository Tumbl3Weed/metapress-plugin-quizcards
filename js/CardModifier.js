 ...
 export default class QuizCardsModifier {
    ...
    get settings () {
        let settings = [
            ...
            { type: 'select', id: 'quizcard_topic_select', name: 'Topic', labels: ['All', 'Random', 'Information Technology', 'Movies', 'Music', 'Sports', 'Geography', 'Television', 'History', 'Gaming', 'Literature'], values: ['all', 'random', 'it', 'movies', 'music', 'sports','geography', 'television', 'history', 'gaming', 'literature'], default: 'all', help: 'Select the topic for the card.' },
